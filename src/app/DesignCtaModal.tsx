    ...
    <div ref={containerRef} className="mx-auto w-fit max-w-full overflow-visible">
      <div ref={wrapRef} className="relative h-16 sm:h-[4.5rem]">
        ...
        <button
          ...
          className={`site-primary-cta site-landing-cta-button absolute left-1/2 top-1/2 inline-flex -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-[#ff6f95] px-6 py-3 text-base font-semibold normal-case tracking-normal text-white shadow-[0_18px_38px_rgba(114,112,111,0.24)] transition-all duration-300 ease-out hover:bg-[#ff4f80] sm:px-7 sm:py-3.5 sm:text-[15px] ${
