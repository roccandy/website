  ...
  return (
    <div className="relative">
      <button
        ...
        aria-expanded={open}
        onClick={openDrawer}
        className="inline-flex h-10 w-10 items-center justify-center text-[#ff6f95] transition-colors hover:text-[#ff4f80] focus-visible:rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff6f95] lg:h-11 lg:w-11"
      >
        <svg viewBox="0 0 24 24" className="h-6 w-6 lg:h-9 lg:w-9" aria-hidden="true">
          <path
            fill="currentColor"
