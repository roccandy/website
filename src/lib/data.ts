...
export type OrderRow = {
  ...
  admin_batch_weights_kg: number[] | null;
  admin_pricing_subtotal: number | null;
  admin_discount_type: string | null;
  admin_discount_value: number | null;
  admin_price_override: number | null;
  admin_price_locked_at: string | null;
  square_customer_id: string | null;
  square_order_id: string | null;
  square_invoice_id: string | null;
  square_invoice_title: string | null;
  square_invoice_version: number | null;
  square_invoice_status: string | null;
  square_invoice_url: string | null;
  square_invoice_due_date: string | null;
  square_invoice_created_at: string | null;
  square_invoice_sent_at: string | null;
  square_invoice_error: string | null;
